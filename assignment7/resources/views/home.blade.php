                ...
                <div class="flex items-start /space-x-3/">
                    ...
                    <div class="text-gray-700 font-normal w-full">
                        <textarea
                            ...
                            name="post" rows="2" placeholder="{{"What's going on, ". $user->firstname ."?"}}"></textarea>
                    </div>
                </div>
            </div>
        ...
        <section id="newsfeed" class="space-y-6">
            ...
            @foreach ($posts as $post)
                <article class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-4 py-5 sm:px-6">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                            role="menuitem" tabindex="-1" id="user-menu-item-1">I don't want to see
                                            this</a>
                                    </div>
                                </div>
                    ...
                    <!-- Content -->
                    <a href="{{ route('singlepost', $post->id) }}" class="py-4 block text-gray-700 font-normal">
                        <p>
                            {{ $post->post }}
                        </p>
                    </a>
